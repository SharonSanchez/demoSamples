define(["require", "exports", "@syncfusion/ej2-base", "../../src/heatmap/heatmap", "../../src/heatmap/legend/legend", "../../src/heatmap/utils/tooltip", "../base/event.spec", "../../spec/common.spec"], function (require, exports, ej2_base_1, heatmap_1, legend_1, tooltip_1, event_spec_1, common_spec_1) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    heatmap_1.HeatMap.Inject(legend_1.Legend, tooltip_1.Tooltip);
    describe('Heatmap Control', function () {
        ...
        describe('Heatmap Legend', function () {
            var heatmap;
            var legend = new legend_1.Legend(heatmap);
            var ele;
            var tempElement;
            var legendElement;
            var created;
            ...
            beforeAll(function () {
                ele = ej2_base_1.createElement('div', { id: 'heatmapContainer' });
            ...
            it('Changing legend position to left', function () {
            ...
            it('Right Position with alignment far', function () {
                heatmap.legendSettings = {
                    height: '50%',
                    alignment: 'Far'
                };
            ...
            it('Right Position with center alignment', function () {
                heatmap.legendSettings = {
                    height: '50%',
                    alignment: 'Center'
                };
            ...
            it('Checking label text when no labels are present', function () {
            ...
            it('Checking trim support in vertical direction', function () {
                heatmap.legendSettings.textStyle.textOverflow = 'Trim';
                heatmap.legendSettings.height = '';
                heatmap.refresh();
                var element = document.getElementById('heatmapContainer_Legend_Label3');
                expect(element.textContent == 'ex...' || element.textContent == 'exc...').toBe(true);
            });
            it('Checking wrap support in vertical direction', function () {
                heatmap.paletteSettings.palette = [
            ...
            it('Checking trim support in horizontal direction', function () {
                heatmap.legendSettings.position = 'Bottom';
            ...
            it('Checking legend label tooltip', function () {
                heatmap.legendSettings.textStyle.textOverflow = 'Trim';
                heatmap.refresh();
            ...
            it('Checking Gradient pointer position in horizontal direction', function () {
                heatmap.legendSettings = {
                    height: '',
                    width: '',
                };
            ...
            it('Checking list type legend in vertical direction', function () {
                heatmap.paletteSettings.type = 'Fixed';
            ...
            it('List type legend with paging', function () {
                heatmap.paletteSettings.type = 'Fixed';
                heatmap.legendSettings.position = 'Bottom';
                heatmap.legendSettings.height = '';
                ...
                var element = legendElement.getBoundingClientRect();
                ...
                var leftArrow = document.getElementById('heatmapContainer_leftArrow');
                var leftArrowelement = leftArrow.getBoundingClientRect();
            ...
            it('List type legend with paging in canvas render mode', function () {
            ...
            it('Checking list type legend in canvas render mode', function () {
                heatmap.legendSettings.position = 'Right';
                heatmap.refresh();
                expect(heatmap.legendModule.labelCollections.length).toBe(8);
            });
            it('Checking list type legend with trim support in canvas ', function () {
                heatmap.renderingMode = 'Canvas';
            ...
            it('Hide the previously rendered gradient pointer', function () {
                ...
                var pointerElement = document.getElementById('heatmapContainer_Gradient_Pointer');
                expect(pointerElement.style.visibility == 'hidden');
            });
            it('Remove previously rendered gradient pointer in canvas in vertical direction', function () {
                heatmap.paletteSettings.type = 'Gradient';
                heatmap.renderingMode = 'Canvas';
                heatmap.refresh();
                legendElement = document.getElementById('heatmapContainer_canvas');
            ...
            it('Remove previously rendered gradient pointer in canvas in horizontal direction', function () {
                heatmap.legendSettings.position = 'Bottom';
                heatmap.refresh();
                legendElement = document.getElementById('heatmapContainer_canvas');
            ...
            it('Checking smart legend for fixed palette type', function () {
                ...
                trigger.mousemoveEvent(legendElement, 5, 5, 30, 35, false);
                var tooltip = document.getElementById('heatmapContainerlegendLabelTooltipContainer_text');
            ...
            it('Checking legend label customization', function () {
                heatmap.legendRender = function (args) {
                    args.cancel = true;
                };
                heatmap.refresh();
                heatmap.legendRender = function (args) {
            ...
            it('Checking toggled cell color after resizing', function (done) {
            ...
            it('Checking cell toggle when only colors are given in the palette collections', function () {
                ...
                heatmap.paletteSettings.palette = [
                    ...
                    heatmap.refresh();
                legendElement = document.getElementById('heatmapContainer_Legend_Label3');
                var region = legendElement.getBoundingClientRect();
            ...
            it('Checking the pages per list when title size is increased', function () {
                heatmap.legendSettings.position = 'Top';
                ...
                heatmap.legendSettings.enableSmartLegend = false;
                heatmap.dataBind();
                var tempElement = document.getElementById('heatmapContainer_LegendBound');
                expect(heatmap.legendModule.listPerPage).toBe(2);
            });
            it('Checking the text in bottom position of the heatmap when the width is not provided', function () {
                heatmap.legendSettings.position = 'Bottom';
                heatmap.legendSettings.width = '';
                heatmap.paletteSettings.type = 'Gradient';
                ...
                var element = document.getElementById('heatmapContainer_legendTitle');
                expect(element.textContent == 'Sample').toBe(true);
            });
            it('Checking the height of the heatmap when the size is changed for the legend title in the Left position', function () {
                heatmap.legendSettings.width = '';
                heatmap.legendSettings.title.text = 'Sample';
                heatmap.legendSettings.title.textStyle.textOverflow = 'None';
            ...
            it('Checking the height of the heatmap when the size is changed for the legend title in the Right position', function () {
                heatmap.legendSettings.width = '';
                heatmap.legendSettings.title.textStyle.textOverflow = 'None';
            ...
            it('Checking the height of the heatmap when the size is changed for the legend title in the Left position without smartlegend', function () {
                heatmap.legendSettings.width = '';
                heatmap.legendSettings.title.textStyle.textOverflow = 'None';
                heatmap.legendSettings.title.textStyle.size = '56px';
                heatmap.paletteSettings.type = 'Fixed';
            ...
            it('Checking the width when title size is changed in the Left direction', function () {
                heatmap.legendSettings.width = '';
                heatmap.legendSettings.title.textStyle.textOverflow = 'None';
            ...
            it('Rendering SVG tooltip for legend title', function () {
            ...
            it('Rendering canvas tooltip for legend title', function () {
                ...
                legendElement = document.getElementById('heatmapContainer_canvas');
                trigger.mousemoveEvent(legendElement, 5, 5, 30, 35, false);
                var tooltip = document.getElementById('heatmapContainer_canvas_Tooltip');
