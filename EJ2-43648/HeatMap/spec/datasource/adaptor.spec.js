define(["require", "exports", "@syncfusion/ej2-base", "../../src/heatmap/heatmap", "../../src/heatmap/index", "../../src/heatmap/index", "../../src/heatmap/index", "../../spec/common.spec"], function (require, exports, ej2_base_1, heatmap_1, index_1, index_2, index_3, common_spec_1) {
    ...
    describe('Heatmap Control', function () {
        ...
        describe('Heatmap Adaptor properties and its behavior', function () {
            var heatmap;
            var ele;
            var tempElement;
            var created;
            var trigger = new MouseEvents();
            var cellNumericData = [[0, 0, null], [0, 1, null], [0, 2, 8], [0, 3, 24], [0, 4, 67],
            ...
            it('Check twoDImentional table dataSource', function () {
            ...
            it('Check twoDImentional table dataSource with min and max value', function () {
            ...
            it('Check cell dataSource with x-axis & y-axis as catagory', function () {
                adaptorData = {
                    isJsonData: false,
                    adaptorType: "Cell",
                };
            ...
            it('Check cell dataSource with x-axis as numeric & y-axis as catagory', function () {
                adaptorData = {
                    isJsonData: false,
                    adaptorType: "Cell",
                };
            ...
            it('Check cell dataSource with x-axis as catagory & y-axis as numeric', function () {
                adaptorData = {
                    isJsonData: false,
                    adaptorType: "Cell",
                };
            ...
            it('Check cell dataSource with x-axis as numeric & y-axis as numeric', function () {
                adaptorData = {
                    isJsonData: false,
                    adaptorType: "Cell",
                };
            ...
            it('Check cell dataSource with x-axis as DateTime & y-axis as DateTime', function () {
                var cellDateData = [[new Date(2018, 1, 1), new Date(2018, 2, 1), 10], [new Date(2018, 1, 1), new Date(2018, 2, 2), null], [new Date(2018, 1, 1), new Date(2018, 2, 3), 8], [new Date(2018, 1, 1), new Date(2018, 2, 4), 24], [new Date(2018, 1, 1), new Date(2018, 2, 5), 67],
            ...
            it('Check cell dataSource Json Table dataSource', function () {
                var jsonTableData = [{
                        "Region": "Pacific",
                        "Jan": 1,
                        "Feb": 0,
            ...
            it('Check cell dataSource with Json Cell dataSource', function () {
                var jsonCellData = [
                    {
                        "rowid": "TestX1",
                        "columnid": "Jan",
            ...
            it('Check json cell complex dataSource behaviour', function () {
                var jsonCellComplexData = [
            ...
            it('Check complex dataSource with size and color bubble cell', function () {
            ...
            it('Check complex json table dataSource with size and color bubble cell', function () {
                var jsonTableComplexData = [
            ...
            it('Check complex dataSource with Rect cell', function () {
            ...
            it('Check dataSource without inject Adaptor', function () {
